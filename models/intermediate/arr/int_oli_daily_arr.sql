...
expanded_daily as (
    select
        ...
        365.0 * oli.total_price / nullif({% if target.type == 'bigquery' %}date_diff(oli.end_date, oli.start_date, day){% else %}DATEDIFF('day', oli.start_date, oli.end_date){% endif %} + 1, 0) as daily_arr
